...
class Courses(Controller):
    ...
    def index(self):
        courses = self.models['Course'].get_all_course()
    ...
    def show(self, id):
        ...
        course = self.models['Course'].get_courses_by_id(id)
    ...
    def add(self):#passing the data from the controller
